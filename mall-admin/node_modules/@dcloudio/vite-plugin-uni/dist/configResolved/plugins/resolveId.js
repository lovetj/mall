...
function uniResolveIdPlugin(options) {
    ...
    const useProjectPinia = isX && (0, uni_cli_shared_1.resolveProjectPinia)() !== undefined;
    // 内部会先判断项目能否解析 vue-i18n，仅无法解析时才返回内置依赖别名。
    const builtInDependencies = {
        // 内部会先判断项目能否解析 pinia，仅无法解析时才返回内置依赖别名。
        ...(0, uni_cli_shared_1.resolvePiniaDependencies)(),
    };
    if (isX) {
    ...
    return {
        ...
        resolveId(id, importer) {
            ...
            if (isX && id === 'pinia') {
                ...
                return (resolveCache[id] = (0, uni_cli_shared_1.resolvePinia)());
            }
