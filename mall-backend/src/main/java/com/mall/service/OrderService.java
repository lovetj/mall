...
public interface OrderService extends IService<Order> {
     ...
     */
    OrderVO checkout(OrderCheckoutDTO dto, Long userId);

    /** 订单分页列表(含订单项) */
    PageResult<OrderVO> pageList(Integer pageNum, Integer pageSize, Integer status, Long userId);
     ...
     */
    Map<Integer, Long> countByUserIdGroupByStatus(Long userId);
}
