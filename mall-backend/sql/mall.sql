-- Database export: mall (Product Multi-Tier / SKU Refactored)
-- Date: 2026-09-16
-- Generated by DBX
...
CREATE TABLE `cart` (
  ...
  `tier_id` varchar(128) NOT NULL COMMENT '商品价格层级/规格ID',
...
CREATE TABLE `order_item` (
  ...
  `product_id` varchar(128) NOT NULL COMMENT '商品ID',
  `tier_id` varchar(128) DEFAULT NULL COMMENT '商品价格层级/规格ID',
  `product_name` varchar(100) NOT NULL COMMENT '商品名称(下单时快照)',
  `tier_name` varchar(100) DEFAULT NULL COMMENT '价格层级/规格名称(下单时快照,如: 1斤装)',
  `product_image` varchar(255) DEFAULT NULL COMMENT '商品/规格图片(下单时快照)',
  `product_unit` varchar(20) DEFAULT NULL COMMENT '商品单位(下单时快照,如: 斤/只)',
...
CREATE TABLE `product` (
  ...
  `price` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '起步基准价格(用于列表快速展示与排序)',
  `unit` varchar(20) DEFAULT '斤' COMMENT '基准单位(如: 斤/只)',
  `stock` int DEFAULT '999' COMMENT '总库存(多规格汇总)',
...
INSERT INTO `product` (`id`, `category_id`, `name`, `image`, `images`, `tags`, `price`, `unit`, `stock`, `description`, `origin`, `sales`, `status`, `sort`, `create_time`, `update_time`) VALUES 
('1', '1', '白辣椒', '/product/20260914_de60e7a595b3482cae86741812a196aa.png', '["/product/images/20260914_3cad270385fe45d6b19334f1ba384c41.png","/product/images/20260914_b80ef9d4db5c453da2587c751cca3e9d.png","/product/images/20260914_36b133aee39f4512be0824fd198cb01e.png"]', '["1"]', 25.00, '斤', 1998, '农家晒制白辣椒，香辣可口，是下饭的好伴侣', '大山村', 0, 1, 1, '2026-09-14 20:39:46', '2026-09-14 23:24:57'),
('2', '1', '豆角干', NULL, '', '["1","2","3"]', 20.00, '斤', 999, '精选新鲜豆角晒制，保留原汁原味', '大山村', 0, 1, 2, '2026-09-14 20:39:46', '2026-09-14 23:38:58'),
('3', '1', '茄子干', NULL, NULL, NULL, 22.00, '斤', 999, '传统工艺晒制，软糯香甜', '大山村', 0, 1, 3, '2026-09-14 20:39:46', '2026-09-14 20:39:46'),
('4', '1', '笋干', NULL, NULL, NULL, 35.00, '斤', 999, '高山竹笋晒制，鲜嫩爽口', '大山村', 0, 1, 4, '2026-09-14 20:39:46', '2026-09-14 20:39:46'),
('5', '2', '辣椒', NULL, NULL, NULL, 8.00, '斤', 999, '新鲜采摘，辣味十足', '大山村', 0, 1, 1, '2026-09-14 20:39:46', '2026-09-14 20:39:46'),
('6', '2', '豆角', NULL, NULL, NULL, 6.00, '斤', 999, '农家种植，新鲜嫩绿', '大山村', 0, 1, 2, '2026-09-14 20:39:46', '2026-09-14 20:39:46'),
('7', '2', '生姜', NULL, NULL, NULL, 10.00, '斤', 999, '老姜味道浓郁，适合烹饪', '大山村', 0, 1, 3, '2026-09-14 20:39:46', '2026-09-14 20:39:46'),
('8', '3', '菜籽油', '/product/20260914_52dc14cac97a4813a74ca64f1a0ef865.png', '["/product/images/20260914_54a3a72652154cf5ad91932fcec81992.png","/product/images/20260914_e8e81445ff6e45f99ba87b9202913d67.png"]', '["1","2"]', 15.00, '斤', 999, '传统压榨，纯正香浓', '大山村', 0, 1, 1, '2026-09-14 20:39:46', '2026-09-14 23:38:31'),
('9', '3', '茶油', NULL, NULL, NULL, 60.00, '斤', 999, '高山茶籽压榨，营养丰富', '大山村', 0, 1, 2, '2026-09-14 20:39:46', '2026-09-14 20:39:46'),
('10', '4', '米酒', NULL, '', '["1","2","3"]', 20.00, '斤', 999, '农家自酿米酒，醇香甘甜', '大山村', 0, 1, 1, '2026-09-14 20:39:46', '2026-09-14 23:38:41'),
('11', '4', '红薯酒', NULL, NULL, NULL, 25.00, '斤', 999, '传统工艺酿造，口感独特', '大山村', 0, 1, 2, '2026-09-14 20:39:46', '2026-09-14 20:39:46'),
('12', '5', '月子鸡', NULL, '', '["1","2","3"]', 150.00, '只', 999, '散养土鸡，滋补佳品', '大山村', 0, 1, 1, '2026-09-14 20:39:46', '2026-09-14 23:38:46'),
('13', '5', '土鸭', NULL, NULL, NULL, 120.00, '只', 999, '农家散养，肉质鲜美', '大山村', 0, 1, 2, '2026-09-14 20:39:46', '2026-09-14 20:39:46'),
('14', '5', '山羊肉', NULL, NULL, NULL, 45.00, '斤', 999, '高山放养，肉质细嫩', '大山村', 0, 1, 3, '2026-09-14 20:39:46', '2026-09-14 20:39:46'),
('15', '5', '黄牛肉', NULL, NULL, NULL, 55.00, '斤', 999, '农家养殖，新鲜宰杀', '大山村', 0, 1, 4, '2026-09-14 20:39:46', '2026-09-14 20:39:46');

DROP TABLE IF EXISTS `product_tier`;

CREATE TABLE `product_tier` (
  `id` varchar(128) NOT NULL COMMENT '主键ID',
  `product_id` varchar(128) NOT NULL COMMENT '商品ID',
  `name` varchar(100) NOT NULL COMMENT '价格层级/规格名称(如: 1斤, 2斤, 500g, 礼盒装)',
  `price` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '售价',
  `original_price` decimal(10,2) DEFAULT NULL COMMENT '原价/划线价',
  `unit` varchar(20) DEFAULT '斤' COMMENT '规格单位',
  `stock` int DEFAULT '999' COMMENT '库存',
  `sales` int DEFAULT '0' COMMENT '销量',
  `image` varchar(255) DEFAULT NULL COMMENT '规格图片(可选,为空继承商品主图)',
  ...
  PRIMARY KEY (`id`),
  KEY `idx_product_id` (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='商品价格层级/规格表';

-- 预置各商品价格层级/规格数据 (例如白辣椒支持1斤装、2斤特惠装、5斤批发装)
INSERT INTO `product_tier` (`id`, `product_id`, `name`, `price`, `original_price`, `unit`, `stock`, `sales`, `image`, `sort`, `status`, `create_time`, `update_time`) VALUES 
('1_1', '1', '1斤装(尝鲜)', 25.00, 28.00, '斤', 999, 0, NULL, 1, 1, '2026-09-14 20:39:46', '2026-09-14 20:39:46'),
('1_2', '1', '2斤装(特惠)', 48.00, 56.00, '斤', 500, 0, NULL, 2, 1, '2026-09-14 20:39:46', '2026-09-14 20:39:46'),
('1_3', '1', '5斤装(家庭量贩)', 115.00, 140.00, '斤', 499, 0, NULL, 3, 1, '2026-09-14 20:39:46', '2026-09-14 20:39:46'),
('2_1', '2', '1斤装', 20.00, NULL, '斤', 999, 0, NULL, 1, 1, '2026-09-14 20:39:46', '2026-09-14 20:39:46'),
('2_2', '2', '2斤装', 38.00, NULL, '斤', 999, 0, NULL, 2, 1, '2026-09-14 20:39:46', '2026-09-14 20:39:46'),
('3_1', '3', '1斤装', 22.00, NULL, '斤', 999, 0, NULL, 1, 1, '2026-09-14 20:39:46', '2026-09-14 20:39:46'),
('4_1', '4', '1斤装', 35.00, NULL, '斤', 999, 0, NULL, 1, 1, '2026-09-14 20:39:46', '2026-09-14 20:39:46'),
('5_1', '5', '1斤装', 8.00, NULL, '斤', 999, 0, NULL, 1, 1, '2026-09-14 20:39:46', '2026-09-14 20:39:46'),
('6_1', '6', '1斤装', 6.00, NULL, '斤', 999, 0, NULL, 1, 1, '2026-09-14 20:39:46', '2026-09-14 20:39:46'),
('7_1', '7', '1斤装', 10.00, NULL, '斤', 999, 0, NULL, 1, 1, '2026-09-14 20:39:46', '2026-09-14 20:39:46'),
('8_1', '8', '1斤装', 15.00, NULL, '斤', 999, 0, NULL, 1, 1, '2026-09-14 20:39:46', '2026-09-14 20:39:46'),
('8_2', '8', '5斤桶装', 70.00, 75.00, '斤', 500, 0, NULL, 2, 1, '2026-09-14 20:39:46', '2026-09-14 20:39:46'),
('9_1', '9', '1斤装', 60.00, NULL, '斤', 999, 0, NULL, 1, 1, '2026-09-14 20:39:46', '2026-09-14 20:39:46'),
('10_1', '10', '1斤装', 20.00, NULL, '斤', 999, 0, NULL, 1, 1, '2026-09-14 20:39:46', '2026-09-14 20:39:46'),
('11_1', '11', '1斤装', 25.00, NULL, '斤', 999, 0, NULL, 1, 1, '2026-09-14 20:39:46', '2026-09-14 20:39:46'),
('12_1', '12', '1只整鸡(约3斤)', 150.00, 168.00, '只', 999, 0, NULL, 1, 1, '2026-09-14 20:39:46', '2026-09-14 20:39:46'),
('13_1', '13', '1只整鸭(约3.5斤)', 120.00, 138.00, '只', 999, 0, NULL, 1, 1, '2026-09-14 20:39:46', '2026-09-14 20:39:46'),
('14_1', '14', '1斤装', 45.00, NULL, '斤', 999, 0, NULL, 1, 1, '2026-09-14 20:39:46', '2026-09-14 20:39:46'),
('15_1', '15', '1斤装', 55.00, NULL, '斤', 999, 0, NULL, 1, 1, '2026-09-14 20:39:46', '2026-09-14 20:39:46');
